...
class Cuentas_list : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var list_temp = ArrayList<Cliente>()
    ...
    override fun onStart() {
        ...
        this@Cuentas_list.lifecycleScope.launch {
            try {
                ...
                runOnUiThread {
                    alert!!.dismisss()
                    Toast.makeText(this@Cuentas_list, e.message.toString(), Toast.LENGTH_LONG)
                        .show()
                }
            }
    ...
    private fun searchClient(dato: String): ArrayList<Cliente> {
        ...
        try {
            ...
            if (consulta.count > 0) {
                consulta.moveToFirst()
                do {
                    //val fecha = consulta.getColumnIndex("Ultima_venta").toString()
                    val listado = Cliente(
                        consulta.getInt(0),
                        consulta.getString(1),
                        consulta.getString(2),
